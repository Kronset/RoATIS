...
int main() {
    ...
    cout << ">> Welcome in RoATIS!" << endl << ">> Application Version 0.0.3!" << endl << ">> Made by kronset_" << endl << ">> Follow me on github https://github.com/Kronset!\n" << endl;
    ...
    cout << "THIS IS " << a << " INFROMATION " << inf << " WIND " << b << " KTS " << "HEADING " << c << direct << " VISIBILITY " << vis << " KM " << "EXPECT APPROACH TO RUNWAY " << arr << " ON INITIAL CONTACT ADVICE " << inf << " ON BOARD " << a << " OUT ";
    system("PAUSE");
    return 0;
}
